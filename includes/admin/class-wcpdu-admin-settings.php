...
class WCPDU_Admin_Settings {
	...
	public function render_enable_upload_field() {
		...
		<label>
			...
			<?php esc_html_e( 'Allow customers to upload design files', 'wcpdu' ); ?>
		</label>
	...
	public function render_max_file_size_field() {
		...
		<p class="description">
			<?php esc_html_e( 'Maximum upload file size in megabytes.', 'wcpdu' ); ?>
		</p>
	...
	public function render_allowed_file_types_field() {
		...
		<p class="description">
			<?php esc_html_e( 'Comma-separated list (e.g. jpg,png,pdf,ai).', 'wcpdu' ); ?>
		</p>
